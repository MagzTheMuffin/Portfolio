...
const Footer = React.forwardRef((props, ref) => {
  return (
    <footer ref={ref} className="bg-dark-navy text-gray-300 p-8 mt-16 text-center">
      ...
      <p>Phone: +44 7818-598-739</p>
      <p>Email: CharlieMagri03@Gmail.com</p>
      <p>LinkedIn: <a href="https://www.linkedin.com/in/charlie-magri-6478b7369/" target="_blank" rel="noopener noreferrer" className="text-pink-400 hover:underline">CharlieMagri</a></p>
